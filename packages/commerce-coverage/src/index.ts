 ...
 * covered.
 */
export type { CoverageConfig, SinkPattern, GuardPattern, LoadedConfig } from "./config.js";
export {
  loadConfig,
  normalizeConfig,
...
export type { AuditResult, Finding, Classification, SuppressedHit } from "./audit.js";
